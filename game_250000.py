...
def run():
	...
	#question base
	qs = ["Koji je klub postavio rekord za najviše osvojenih poena (186) u jednoj NBA utakmici?",
			"Tko je nosio hrvatsku zastavu na otvaranju OI u Ateni 2004?",
			"Koliko je iznosio servis Ive Karlovića s kojim je srušio svjetski rekord?",
			"Najviše nastupa u Premier Ligi ima Gareth Barry koji je većinu karijere proveo u...",]

	#wrong answers base
	wanss = [["Charlote","Chicago","Boston"],
			["Perica Bukić","Zoran Primorac","Goran Ivanišević"],
			["137 km/h","248 km/h","322 km/h"],
			["Evertonu","WBA-u","Blackburnu"],]
	...
	def ansA_func(event):
		...
		if ansA_button.cget("fg") == "green":
			...
			money_250000_label.destroy()
		
			money_250000_button = Button(money_250000_frame,text="DALJE !!",bg="black",fg="red",font="arial 10 bold")
			money_250000_button.config(width=24,height=1)
			money_250000_button.bind("<Button>",next_500000)
			money_250000_button.pack()

		else:
			q_label.config(text="VAŠ ODGOVOR JE NETOČAN. OSVOJILI STE 32000 KN")
			money_won = "32000"
	...
	def give_up_func(event):
		...
		q_label.config(text="ODUSTALI STE. OSVOJILI STE 125000 KN")
		money_won = "125000"
	...
	def next_500000(event):
		money_250000_button.bind("<Button>",next_500000_false)
		game_500000.run()

	def next_500000_false(event):
		pass
	...
	#game system
	money_250000_label.config(fg="red")
	jok_50_used = False
