...
def run():
	...
	#question base
	qs = ["Koja je najduža rijeka koja prolazi Argentinom?",
			"Koje je godine osnovana Kneževina Monako?",
			"Kada je po prvi put na tržištu predstavljen USB?",
			"Koji je rodni grad renesansnog talijanskog slikara Raphaela?",]

	#wrong answers base
	wanss = [["Iguazu","Pilcomayo","Colorado"],
			["1284.","1498.","1849."],
			["10 mj. 1995.","3 mj. 1996.","11 mj. 1996."],
			["Rim","Parma","Firenca"],]
	...
	def ansA_func(event):
		...
		if ansA_button.cget("fg") == "green":
			...
			money_500000_label.destroy()
		
			money_500000_button = Button(money_500000_frame,text="DALJE !!",bg="lightblue",fg="red",font="arial 10 bold")
			money_500000_button.config(width=24,height=1)
			money_500000_button.bind("<Button>",next_1000000)
			money_500000_button.pack()
	...
	def give_up_func(event):
		...
		q_label.config(text="ODUSTALI STE. OSVOJILI STE 250000 KN")
		money_won = "250000"
	...
	def next_1000000(event):
		money_500000_button.bind("<Button>",next_1000000_false)
		game_1000000.run()

	def next_1000000_false(event):
		pass
	...
	#game system
	money_500000_label.config(fg="red")
	jok_50_used = False
